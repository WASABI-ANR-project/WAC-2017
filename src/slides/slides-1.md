...
- **Analyze** audio content with audio feature extraction libraries (Aubio, Yaafe, VAMP, Essentia, etc..) as well as some pure python processors
- **Visualize** sounds and analysis data
- **Transcode** audio data in various media formats and stream them through web apps,
- **Serialize** MIR data through various portable formats,
- **Playback** and **interact** on demand through a HTML5 extensible player,
- **Index**, **tag** and **annotate** audio archives with semantic metadata
- **Deploy** and **scale** a **Restful API** as an audio processing service
...
- A full web app to browse multidimensional data
- Collaborative Web tools for automatic, semi-automatic and manual audio indexing (Parisson, IRCAM)
- Mixing table / multitrack player, chainable high-level audio effects, guitar amp simulators, interactive audio music browser
- Search engine driven by audio (midi input, audio extracts)
- Interactive tutorials (music schools)
...
- Journalism : David Bowie network data review (Radio France)
- Musicology : demixed contemporary music annotation (IRCAM)
- Music composition : realtime granular synthesis through historical data (IRCAM)
- Music browsing : improving production metadata access and recommandation (Deezer)
- Teaching : replay Michel Buffa greatest songs!
...
- harvesting 2M large scale and multidimensional web music data
- publishing metadata and services through open APIs
- testing use cases with professionals and industry
- improving music browsing and listening experience
