...
- Music browsing : improving metadata access and recommandation (Deezer)
...
- harvesting 2M large scale web music data
- indexing data in web app + APIs
- imroving music browsing experience
- testing use cases with professionals

##Results

- one API for semantics
- one API for audio features + lyrics alignment + active learning
- a full web app to browse multidimensional data
- demixing audio data for better annotation
